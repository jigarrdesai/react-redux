...
1.Add a constant to the constants file. Something like `const GREAT_COURSE = ‘GREAT_COURSE`<br>

2.Add an action creator to the actions folder. Return an action JavaScript object with a type of the constant you created.<br>

3.Add a reducer to the reducers folder that handles this action creator.<br>
